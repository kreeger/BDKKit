...
/** Adds some helper methods to a UICollectionView to assist in traversing index paths.
 */
 ...
 *  @return The next up index path. If the max is reached, it will return minimumIndexPath.
 */
 ...
 *  @return The previous index path. If the minimum is reached, it will return maxiumumIndexPath.
 */
